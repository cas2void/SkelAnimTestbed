...
FHandEditSkinnedMeshSceneProxy::FHandEditSkinnedMeshSceneProxy(const UHandEditSkinnedMeshComponent* Component)
    : FPrimitiveSceneProxy(Component)
    , VertexFactory(GetScene().GetFeatureLevel(), "FHandEditSkinnedMeshSceneProxy")
{
...
FHandEditSkinnedMeshSceneProxy::~FHandEditSkinnedMeshSceneProxy()
{
...
void FHandEditSkinnedMeshSceneProxy::GetDynamicMeshElements(const TArray<const FSceneView*>& Views, const FSceneViewFamily& ViewFamily, uint32 VisibilityMap, FMeshElementCollector& Collector) const
{
...
FPrimitiveViewRelevance FHandEditSkinnedMeshSceneProxy::GetViewRelevance(const FSceneView* View) const
{
